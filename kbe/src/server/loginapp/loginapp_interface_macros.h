...
*/
	...
	#undef KBE_LOGINAPP_INTERFACE_MACRO_H
#endif
...
/**
	Loginapp message macro, parameter is stream, need to unpack
*/
...
/**
	Loginapp message macro, 0 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 1 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 2 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 3 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 4 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 5 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 6 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
...
/**
	Loginapp message macro, 8 parameter message
*/
#if defined(NETWORK_INTERFACE_DECLARE_BEGIN)
